...
<Box bgcolor="text.secondary" color="background.paper"  p={5} className="boxlike1">
...
<div>
        ...
        <Box bgcolor="text.disabled" color="background.paper"  p={5} className="box02">
        <p>
۳ .   شرح تصویر که زیر آن دیده می‌شود
</p><p>
۴ .  ابزار سئو و چک کردن آن‌ها
...
۸ .  گراف باز</p>
        ...
        <Box bgcolor="text.disabled" color="background.paper"  p={5} className="boxlike2">
...
<Box width="50%" bgcolor="grey.300" p={1} my={0.5}>
     ...
     <Box bgcolor="text.secondary" color="primary.contrastText" p={2}  className="box03">
     <p>یک سایت خوب که می توانید برای بهینه سازی تصاویر سایت خود استفاده کنید سایت tinypng است.
...
<Box bgcolor="text.secondary" color="background.paper"  p={5} className="boxlike3">
